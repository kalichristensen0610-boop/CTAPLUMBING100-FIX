...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="en"><body className="font-sans antialiased"><JsonLd data={localBusiness} /><SiteShell>{children}</SiteShell><Script src="https://api.christensenandcoagency.com/js/external-tracking.js" data-tracking-id="tk_8654988435c84995a3a96b88674a170b" strategy="afterInteractive" /></body></html>;
}
