...
export const campaignLeadSchema=z.object({
  ...
  utmSource:optionalText(150),utmMedium:optionalText(150),utmCampaign:optionalText(150),utmContent:optionalText(150),utmTerm:optionalText(150),gclid:optionalText(300),fbclid:optionalText(300),website:z.string().max(200).optional(),formStartedAt:z.number().optional(),formSessionId:z.string().max(100).optional(),turnstileToken:z.string().max(2048).optional(),
});
